  ...
  const values = [
    {
      icon: Target,
      title: "DISCIPLINE",
      description: "We instill discipline through structured training, respect for the game, and commitment to excellence both on and off the pitch."
    },
    {
      icon: Zap,
      title: "FLAIR",
      description: "We celebrate creativity, individual expression, and the street-style artistry that makes football beautiful and unpredictable."
    },
    {
      icon: Award,
      title: "GREATNESS",
      description: "We push every player to reach their full potential, creating champions who dominate on the pitch and inspire in the community."
    }
  ];
  ...
  const team = [
    {
      ...
      bio: "Built KOTP from the streets of Western Sydney",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=2000"
    },
    {
      name: "SARAH WILLIAMS",
      role: "Academy Director",
      bio: "Former professional player, developing next gen talent",
      image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=2000"
    },
    {
      name: "DAVID NGUYEN",
      role: "Tournament Director",
      bio: "Creating unforgettable competitive experiences",
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=2000"
    },
    {
      name: "EMILY PATEL",
      role: "Youth Development Coach",
      bio: "Nurturing talent from grassroots to glory",
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 leading-relaxed">
              We're not just a football organization. We're a movement that transforms raw talent into greatness,
              giving Western Sydney's athletes the platform they deserve.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-300 text-xl leading-relaxed max-w-4xl">
              King of the Pitch exists to provide a world-class platform for Western Sydney's football talent.
              We combine the raw energy of street football with professional-level competition, creating an environment
              where discipline, flair, and greatness aren't just values—they're a way of life. From our elite academy
              to our legendary tournaments, we're building the next generation of football champions.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 text-xl max-w-3xl mx-auto">
              Led by passionate individuals who live and breathe football
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-gray-400 text-xl mb-8">
              Whether you want to compete, train, or support—there's a place for you in the kingdom
            </p>
