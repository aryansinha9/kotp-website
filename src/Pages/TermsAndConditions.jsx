      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <Section icon={FileText} title="1. Conditions of Entry">
            <p>All persons entering the premises of Ultimate Soccer accept full responsibility for any injury or illness. You release and discharge KOTP from any claim or cost related to your participation. Use of the facilities is at your own risk. Key facility rules include: no climbing on fences, no alcohol on pitches, no glass bottles, no smoking, and children under 16 must be supervised.</p>
          </Section>

          <Section icon={Users} title="2. Registration Requirements">
            <p>All teams must register through the official KOTP system with true and accurate information. Registration is not confirmed until the required fee is paid in full.</p>
          </Section>
          ...
          <Section icon={Camera} title="5. Media Consent">
            <p>By attending any KOTP event, you consent to being photographed, videoed, and recorded for use across KOTP's websites, social media, and promotional materials.</p>
          </Section>

          <Section icon={Shield} title="6. Liability">
            <p>Participation is at your own risk. KOTP is not liable for injuries, illnesses, or personal property loss.</p>
          </Section>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    By registering for any KOTP event or using our services, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.
                  </p>
                </div>
              </div>
            </div>
