// src/Pages/LiveScores.jsx (Corrected - Full component definitions restored)
...
export default function LiveScores() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on('postgres_changes', { event: 'UPDATE', schema: 'public', table: 'games', filter: `tournament_id=eq.${selectedTournament}` }, 
      (payload) => {
        setGames(currentGames => currentGames.map(game => game.id === payload.new.id ? payload.new : game));
      })
      .subscribe();
