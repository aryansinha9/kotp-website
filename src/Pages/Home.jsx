      ...
      <section className="relative py-24 bg-[#0a0a0a] overflow-hidden min-h-[600px] flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="text-center">
            <h2 className="headline-font text-5xl md:text-7xl text-white mb-4 pointer-events-none">TRAIN LIKE A CHAMPION.</h2>
            <p className="headline-font text-gray-400 text-2xl tracking-wide mb-8 pointer-events-none">Elite coaching. Real development. Real results.</p>
            <Link to="/academy">
      ...
      <section className="relative py-32 px-4 bg-[#0a0a0a] overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
            ...
            <button type="button" onClick={(e) => e.preventDefault()} className="kotp-button bg-[#FF6B00]/80 text-white px-12 py-5 rounded-md headline-font text-2xl tracking-wider cursor-default">REGISTER NOW</button>
          </motion.div>
        </div>
      </section>
    </div>
