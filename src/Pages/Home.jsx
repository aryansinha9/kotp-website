      ...
      <section className="relative py-24 px-4 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <ServiceCard title="TOURNAMENTS" description="Compete against the best. Show your skills. Claim your crown." image="https://images.unsplash.com/photo-1459865264687-595d652de67e?q=80&w=2000" size="large" icon={() => <img src="https://gjeepzarenavlrnpvyee.supabase.co/storage/v1/object/public/tournament-gallery/site-assets/Gemini_Generated_Image_2q2yk2q2yk2q2yk2-Photoroom.svg" alt="Trophy" className="w-32 h-32 -ml-8" />} delay={0.2} linkTo="/tournaments" />
            <ServiceCard title="ACADEMY" description="Train with the best. Develop your game. Become unstoppable." image="https://images.unsplash.com/photo-1606925797300-0b35e9d1794e?q=80&w=2000" size="small" icon={() => <img src="https://gjeepzarenavlrnpvyee.supabase.co/storage/v1/object/public/tournament-gallery/site-assets/Gemini_Generated_Image_61vkm061vkm061vk-Photoroom.svg" alt="Academy" className="w-24 h-24 -ml-4" />} delay={0.4} linkTo="/about" />
            <ServiceCard title="MOMENTS" description="Epic plays. Legendary celebrations. Captured forever." image="https://images.unsplash.com/photo-1574629810360-7fbbe195018?q=80&w=2000" size="small" icon={() => <img src="https://gjeepzarenavlrnpvyee.supabase.co/storage/v1/object/public/tournament-gallery/site-assets/Gemini_Generated_Image_ps4ibups4ibups4i-Photoroom.svg" alt="Camera" className="w-24 h-24 -ml-4 mt-2" />} delay={0.6} linkTo="/moments" />
          </div>
        </div>
      </section>
