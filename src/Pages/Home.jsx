  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50">
          <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12"><h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Our Valued Partners</h2><p className="text-xl text-slate-600 max-w-3xl mx-auto">We're proud to collaborate with leading brands to bring the best youth football experience.</p></div>
