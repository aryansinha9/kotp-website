      ...
      <section className="relative py-24 px-4 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <ServiceCard title="TOURNAMENTS" description="Compete against the best. Show your skills. Claim your crown." image="https://drive.google.com/uc?export=view&id=1d84EKUGaHH_unseSMIjZZeLrxibkl99y" size="large" icon={() => <img src="https://gjeepzarenavlrnpvyee.supabase.co/storage/v1/object/public/tournament-gallery/site-assets/Gemini_Generated_Image_2q2yk2q2yk2q2yk2-Photoroom.svg" alt="Trophy" className="w-20 h-20" />} delay={0.2} linkTo="/tournaments" />
            <ServiceCard title="ACADEMY" description="Train with the best. Develop your game. Become unstoppable." image="https://drive.google.com/uc?export=view&id=1xMGj6aDnsmxMz9GIz7qhB-cLar0cLmkj" size="small" icon={() => <img src="https://gjeepzarenavlrnpvyee.supabase.co/storage/v1/object/public/tournament-gallery/site-assets/Gemini_Generated_Image_61vkm061vkm061vk-Photoroom.svg" alt="Academy" className="w-16 h-16" />} delay={0.4} linkTo="/academy" />
            <ServiceCard title="MOMENTS" description="Epic plays. Legendary celebrations. Captured forever." image="https://drive.google.com/uc?export=view&id=1bxDZKyHGPlWuISm8hEJK0PxjnIhrRA3f" size="small" icon={() => <img src="https://gjeepzarenavlrnpvyee.supabase.co/storage/v1/object/public/tournament-gallery/site-assets/Gemini_Generated_Image_ps4ibups4ibups4i-Photoroom.svg" alt="Camera" className="w-16 h-16" />} delay={0.6} linkTo="/moments" />
          </div>
        </div>
      </section>
