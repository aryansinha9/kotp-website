      ...
      <section className="relative py-24 px-4 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <ServiceCard title="TOURNAMENTS" description="Compete against the best. Show your skills. Claim your crown." image="https://images.unsplash.com/photo-1459865264687-595d652de67e?q=80&w=2000" size="large" icon={() => <img src="https://gjeepzarenavlrnpvyee.supabase.co/storage/v1/object/public/tournament-gallery/site-assets/Gemini_Generated_Image_2q2yk2q2yk2q2yk2-Photoroom.svg" alt="Trophy" className="w-20 h-20" />} delay={0.2} linkTo="/tournaments" />
