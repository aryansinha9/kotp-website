  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1551698618-1dfe5d97d256?ixlib=rb-4.0.3&auto=format&fit=crop&w=2940&q=80"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
          <div className="flex items-center justify-center gap-3 bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
            ...
            <div className="text-left">
              <p className="font-semibold">Sept 14-16</p>
              <p className="text-sm text-white/70">3 Days of Action</p>
            </div>
          </div>
          <div className="flex items-center justify-center gap-3 bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
            <MapPin className="w-6 h-6 text-amber-400" />
            <div className="text-left">
              <p className="font-semibold">Olympic Park</p>
              <p className="text-sm text-white/70">Sydney, NSW</p>
            </div>
          </div>
          <div className="flex items-center justify-center gap-3 bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
            <Users className="w-6 h-6 text-amber-400" />
            <div className="text-left">
              <p className="font-semibold">U12 - U18</p>
